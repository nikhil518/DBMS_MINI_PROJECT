...
class Login(QWidget , login):
    ...
    def Handel_Login(self):
        self.db = MySQLdb.connect(host='localhost', user='root', password='Sunny123@3', db='library')
...
class MainApp(QMainWindow , ui):
    ...
    def Handle_Buttons(self):
        ...
        self.pushButton_8.clicked.connect(self.Dark_Gray_Theme)
   ...
   ########### Day Operations##################
    ...
    def Search_Books(self):
        ...
        self.comboBox_13.setCurrentText(data[6])
        self.lineEdit_12.setText(str(data[7]))
    ...
    def Add_New_Client(self):
        ...
        client_nationalid = self.lineEdit_9.text()
    ...
    def Edit_Client(self):
        client_original_national_id = self.lineEdit_10.text()
    ...
    def Add_Category(self):
        ...
        category_name = self.lineEdit_24.text()
    ...
    def Add_Author(self):
        ...
        author_name = self.lineEdit_25.text()
